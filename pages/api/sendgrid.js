...
async function sendEmail(req, res) {
  try {
    await sendgrid.send({
      to: "richiegenetan14@gmail.com", // Your email where you'll receive emails
      from: "richiegenetan14@gmail.com", // your website email address here
      subject: `[Lead from Richie Gene Tan's Portfolio Website] : ${req.body.subject}`,
      ...
      <body>
        <div class="img-container" style="display: flex;justify-content: center;align-items: center;border-radius: 5px;overflow: hidden; font-family: 'helvetica', 'ui-sans';">              
              ...
              <img src="https://www.richiegenetan.com/avatar.png" class="logo-image" style="height: 50px;width: 50px;border-radius: 5px;overflow: hidden;">
              <p class="footer" style="font-size: 16px;padding-bottom: 20px;border-bottom: 1px solid #D1D5DB;">Best regards,<br>Richie Gene Tan<br>Full-Stack Developer<br>+63 916-424-9531</p>
              <div class="footer-links" style="display: flex;justify-content: center;align-items: center;">
                <a href="https://www.richiegenetan.com/" style="text-decoration: none;margin: 8px;color: #9CA3AF;">Website</a>
